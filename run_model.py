...
# predict_severity(output_file=OUTPUT_PREDICT_SEVERITY_PATH,
#            pca_df=pca_df,
#           binarizer_file=BINARIZER_MODEL_PATH,
#         threshold=THRESHOLD_MODEL)
...
filter_final_result(annotated_result_file=ANNOTATED_SEVERITY_RESULT_PATH,
                    conflicting_type_file=CONFLICT_PATH,
                    output_file=FILTER_FINAL_RESULT_PATH)